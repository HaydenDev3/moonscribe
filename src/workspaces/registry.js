export const WORKSPACE_REGISTRY = [
  ...
  { key: 'family-tree', label: 'Family tree', icon: 'fa-solid fa-people-roof', group: 'World', defaultVisible: true },
  ...
  { key: 'story-memory', label: 'Story Memory', icon: 'fa-solid fa-brain', group: 'Craft', defaultVisible: true },
  { key: 'prose-tools', label: 'Prose tools', icon: 'fa-solid fa-spell-check', group: 'Craft', defaultVisible: true },
