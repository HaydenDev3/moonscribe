...
const ALL_STORES = ['novels', 'chapters', 'characters', 'notes', 'relationships', 'stats', 'world', 'moodboard', 'projectFiles', 'workspacePreferences', 'authorWebsites', 'glossary', 'annotations', 'branches', 'suggestions', 'factProvenance', 'continuityConflicts', 'readMarkers', 'meta']
